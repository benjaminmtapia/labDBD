        ...
        DB::statement('
            ...
            $$
                ...
                LOOP
                    ...
                    this:= this + 3;
                    next:= next + 7;
                    INSERT INTO rooms(hotel_id, numero, capacidad, disponible, created_at, updated_at, fecha_ida, fecha_vuelta, package_id) 
                    VALUES (valor, n, rdm, disponible, NEW.created_at, NEW.updated_at, this, next, valor);
                END LOOP;
                RETURN NEW;
            END
            $$ LANGUAGE plpgsql;
